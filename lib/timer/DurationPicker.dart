// Code taken and modified from flutter duration picker package
...
class _DialPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    TextPainter textDurationValuePainter = new TextPainter(
        ...
        text: new TextSpan(
          text: '${hours}${minutes} min',
          style: TextStyle(color: Colors.grey[400], fontSize: size.shortestSide * 0.15)),
  ...
  List<TextPainter> _buildMinutes(TextTheme textTheme) {
    ...
    for (Duration duration in _minuteMarkerValues) {
      var painter = new TextPainter(
        text: new TextSpan(style: TextStyle(color: labelColor), text: duration.inMinutes.toString()),
